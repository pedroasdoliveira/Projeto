...
let tempo = {
    ...
    relogio: function() {
        ...
        if (this.hora < 4 || this.hora >= 19) {
            console.log(`Anoitecer.`);
            console.log(`Os monstros agora são um pouco mais forte e resistentes.`);
        }

        else if (this.hora > 15 || this.hora < 19) {
            console.log(`O dia já escureceu.`);
            console.log(`Os monstros agora são um pouco mais forte.`);
        }
    } 
}
...
let ataque = status.forca * 5;
let vigorMaximo = status.vigor * 6;
let cansaso = vigorMaximo;
let esquiva = status.habilidade;
let vidaMaxima = status.vitalidade * 50;
let vidaPersonagem = vidaMaxima;
...
function castelo() {
    ...
    console.log(`O grande ${bosses[3]} sumiu em cinzas negras liberando a passagem do antigo portão da torre a caminho ao castelo. Um grande sentimento de grandeza e de esperança surge em você, como uma chama de uma fogueira fraca reacendendo, iluminando o seu caminho escuro a frente. Você começa a entender o motivo de sua existencia e assim descide seguir em frente.`);
    console.log(`Uma nova fogueira surge pra você no seu caminho, onde você restaura sua forças pra seguir rumo as antigas fortificações do castelo do Rei Wolnir. A sua jornada só está começando.`);
    console.log();
    
    seguir = prompt('Precione Enter pra finalizar...');
    console.log();
    console.log();

    console.log(`==> Obrigado por jogar ${personagem}. Nos vemos em breve`);
    console.log(`==> Continua...`);
}

// Função de Vigor contra o Boss
const CansasoBoss = () => {
    if (cansaso <= 0) {
        ataque = 0;
        esquiva = 0;
...
function combate() {
    ...
    console.log();
    mob = monstros[Math.round(Math.random() * 6)];
    console.log(`==> O monstro é um ${mob}.`);

    if (tempo.hora < 4 || tempo.hora >= 19) {
        vidaMonstro = Math.round(Math.random() * 300) + 500;
        console.log();
        console.log(`Anoitecer`);
    }
    else {
        vidaMonstro = Math.round(Math.random() * 200) + 250;
    }
...
function conflito() {
    for (let i = 0; i <= vidaMonstro || i <= vidaPersonagem; i++) {
        ...
        if (tempo.hora > 15 || tempo.hora < 19) {
            danoMonstro = Math.round(Math.random() * 30) + 40;
            console.log();
            console.log(`Atardecer`);
        }
        else if (tempo.hora < 4 || tempo.hora >= 19) {
            danoMonstro = Math.round(Math.random() * 50) + 40;
            console.log();
            console.log(`Anoitecer`);
        }
        else {
            danoMonstro = Math.round(Math.random() * 30) + 25;
        }
        console.log(`==> Dano do monstro: ${danoMonstro}.`);

        dado_ataque = Math.round(Math.random() * 10);
        critico = Math.round(Math.random() * 10);
        ...
        if (dado_ataque >= 5) {
            ...
            if (vidaMonstro <= 0) {
                ...
                if (status.sorte > 5 && status.sorte <= 12) {
                    dado_sorte = Math.round(Math.random() * 3) + 3;
                    ...
                    if (tempo.hora > 15 || tempo.hora < 19) {
                        ...
                        status.souls += 350 * dado_sorte;
                        console.log();
                        console.log(`Você recebeu ${350 * dado_sorte} de almas`);
                    }
                    else {
                ...
                if (status.sorte > 12 && status.sorte <= 18) {
                    dado_sorte = Math.round(Math.random() * 6) + 3;
                    console.log(`dado lançado: ${zero(dado_sorte)}`);
                    ...
                    if (tempo.hora > 15 || tempo.hora < 19) {
                        ...
                        status.souls += 500 * dado_sorte;
                        console.log();
                        console.log(`Você recebeu ${500 * dado_sorte} de almas`);
                    }
                    else {
                        status.souls += 200 * dado_sorte;
                        console.log();
                ...
                if (status.sorte > 18) {
                    dado_sorte = Math.round(Math.random() * 9) + 5;
                    console.log(`dado lançado: ${zero(dado_sorte)}`);
                    ...
                    if (tempo.hora > 15 || tempo.hora < 19) {
                        ...
                        status.souls += 650 * dado_sorte;
                        console.log();
                        console.log(`Você recebeu ${650 * dado_sorte} de almas`);
                    }
                    else {
                        status.souls += 350 * dado_sorte;
                        console.log();
                ...
                console.log();
                console.log(`==> Você tem ${Math.round(status.souls)} de almas.`);
                console.log(`Status do ${status.nome}:`, status);
        ...
        if (dado_ataque < 5) {
            ...
            console.log(`A vida do seu personagem é de ${Math.round(vidaPersonagem)} hp.`);*/
        }

        if (vidaPersonagem <= vidaPersonagem / 2) { // Função de poções
...
// Função de vigor contra Monstros
...
// Função de vigor(cansaso)
    if (cansaso <= 0) {
        ...
        if (recuar == `sim` || recuar == `s` || recuar == `SIM`) { 
            cansaso = vigorMaximo;
            vidaMonstro += 75;
            ataque = ataque; // verificar
            esquiva = esquiva;
            console.log(`Vigor recuperado: ${cansaso}`);
...
function Esquiva(a) {
    if (esquiva >= 5) {
        dado_esquiva = Math.round(Math.random() * 5);
    } else if (esquiva >= 11) {
        dado_esquiva = Math.round(Math.random() * 7);
    } else if (esquiva >= 15) {
        dado_esquiva = Math.round(Math.random() * 10);
    } else if (esquiva >= 19) {
        dado_esquiva = Math.round(Math.random() * 12)+ 1;
    }
    ...
    if (dado_esquiva == 3) {
        ...
        vidaPersonagem -= a / 2;
        console.log(`Tomou: ${Math.round(a / 2)} de dano.`);
        console.log(`A vida do seu personagem é de ${Math.round(vidaPersonagem)} hp.`);
        cansaso -= 5;
...
function fogueira() {
    ...
    console.log(`Escolha a opção 5 caso queira parar de jogar.`);
    var decisao = +prompt();
    regex = /[1-5]/;
    console.log();
    ...
    if (decisao == 1) {
        ...
        console.log(`Você decidiu parar de jogar.`);
        console.log(`-----------------------------------------`);
        console.log();
...
function mercante() {
    ...
    console.log();
    console.log(`Escolha o que você quer comprar: 1 -> Poções, 2 -> Armas ou 3 -> Componentes para armadura.`);
    let compras = +prompt();
    console.log();
    regex = /[1-3]/;
    ...
    // Comprar armadura
        ...
        let armadura = 3500;
        console.log(`Melhoria para a armadura custa ${armadura} almas`);
        console.log();
        console.log(`Pretende comprar essa armadura inicial?`);
        let comprarArmadura = prompt(``);
        console.log();

        if (comprarArmadura == `sim`.toLowerCase || comprarArmadura == `sim`.toUpperCase || comprarArmadura == `s`) {
            status.souls -= armadura;
            console.log(`==> Você melhorou sua armadura inicial.`);
            console.log(`Almas: ${status.souls} almas.`);
            console.log();
            vidaMaxima += 50;
            vidaPersonagem = vidaMaxima;
            console.log(`==> Vida aumentada em 50. Vida: ${vidaMaxima} hp`);
        }
    }
...
function portao() {
    ...
    if (decisao == 1) {
        ...
        console.log(status);
        console.log(`ATENÇÃO! Você realmente pretende enfrentar o Boss agora? Você está preparado para lutar contra ele?`);
        var atencao = prompt(``);
...
function torre () {
    ...
    for (let j = 0; j <= vidaBoss || j <= vidaPersonagem; j++) {
        ...
        danoBoss = Math.round(Math.random()* 60) + 60;
        ...
        dado_ataque = Math.round(Math.random() * 15);
        critico = Math.round(Math.random() * 20);
        console.log();
        ...
        if (vidaPersonagem <= vidaPersonagem / 2) {
            console.log(`Você pretende usar uma poção?`);
            let usarPocao = prompt(``);
            console.log();
            if (usarPocao == `sim` || usarPocao == `s`) {
        ...
        if (vidaBoss <= 0) {
            console.log(`-------------------------------------`);
            console.log(`==> Você derrotou o ${bosses[3]}.`);
            console.log();
            cansaso = vigorMaximo;
            console.log(`==> Vigor regenerado: ${cansaso}`);
            vidaPersonagem = vidaMaxima;
            ...
            if (status.sorte > 5 && status.sorte <= 12) {
                dado_sorte = Math.trunc(Math.random() * 3) + 5;
                console.log(`==> dado lançado: ${zero(dado_sorte)}`);
                status.souls += 2000 * dado_sorte;
                console.log();
                console.log(`==> Você recebeu ${2000 * dado_sorte} de almas`);
            }
            if (status.sorte > 12 && status.sorte <= 18) {
                dado_sorte = Math.trunc(Math.random() * 6) + 5;
                console.log(`dado lançado: ${zero(dado_sorte)}`);
                status.souls += 2500 * dado_sorte;
                console.log();
                console.log(`==> Você recebeu ${2500 * dado_sorte} de almas`);
            }
            if (status.sorte > 18) {
                dado_sorte = Math.trunc(Math.random() * 9) + 7;
                console.log(`dado lançado: ${zero(dado_sorte)}`);
                status.souls += 4000 * dado_sorte;
                console.log();
                console.log(`==> Você recebeu ${4000 * dado_sorte} de almas`);
            }
            console.log();
